...
const FullViewPage = (
    ...
    return (
        <div className={`${css} overflow-h full-view-min bg-second flex column center pos-rel`} style={varStyles}>
            ...
            <Eclipse size='calc(1vh + 2vw)' w='calc(45vw + 3vh)' top="50%" left="-20%" css='pos-abs h4p anim-float-slow'/>
