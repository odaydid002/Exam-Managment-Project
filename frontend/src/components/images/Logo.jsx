    ...
    return (       
        <div className='flex row center' style={{width:wc}}>
            <svg className={`${classes || ""}`} style={varStyle} xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1" viewBox="0 0 400 400">
                <rect style={{fill: forceLight?"var(--logo":""}} className={`${styles.st3}`} x="98.31" y="204.03" width="37.83" height="35.14" rx="4.6" ry="4.6"/>
                <rect style={{fill: forceLight?"var(--logo":""}} className={`${styles.st3}`} x="156.96" y="204.03" width="37.83" height="35.14" rx="4.6" ry="4.6"/>
                <rect style={{fill: forceLight?"var(--logo":""}} className={`${styles.st3}`} x="98.31" y="261.4" width="37.83" height="35.14" rx="4.6" ry="4.6"/>
                <rect style={{fill: forceLight?"var(--logo":""}} className={`${styles.st3}`} x="156.96" y="261.4" width="37.83" height="35.14" rx="4.6" ry="4.6"/>
                <path style={{fill: forceLight?"var(--logo":""}} className={`${styles.st3}`} d="M297.67,99.49l-16.14,6.9v39.4c4.15,1.77,7.07,5.9,7.07,10.7,0,2.98-1.11,5.7-2.99,7.76l6.74,20.36c.56,1.68-.71,3.41-2.47,3.41h-25.73c-1.81,0-3.09-1.74-2.53-3.47l6.53-20.51c-1.74-2.04-2.79-4.66-2.79-7.55,0-4.61,2.69-8.6,6.58-10.46v-35.53l-80.77,34.53c-4.66,1.37-8.61,1.42-11.05.57l-109.61-45.49c-5.76-3.32-6.87-8.58-1.11-11.92l107.32-43.6c2.67-1.54,10.16-1.65,12.84-.11l107.61,43.85c5.77,3.32,4.58,8.41.52,11.16Z"/>
