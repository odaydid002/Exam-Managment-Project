...
const StudentHome = () => {
  return (
    ...
    {/*
      */}
      <PrimaryButton mrg="auto" text='Add' icon='fa-solid fa-plus' onClick={() => {}} />
      <PrimaryButton w="10em" mrg='1em' text='Submit' onClick={() => {}} />
      <SecondaryButton w='calc(100% - 1em)' mrg='1em auto' text='Cancel' onClick={() => {}}/>
