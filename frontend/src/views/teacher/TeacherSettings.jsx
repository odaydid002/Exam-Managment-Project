...
const TeacherSettings = () => {
  ...
  const saveSettings = async (patch) => {
    ...
    const mapLocalToServer = (p) => {
      const out = {};
      if (Object.prototype.hasOwnProperty.call(p, 'theme')) out.theme = p.theme;
      if (Object.prototype.hasOwnProperty.call(p, 'theme_color')) out.main_color = p.theme_color;
      if (Object.prototype.hasOwnProperty.call(p, 'two_factor')) out.two_factor_authentication = p.two_factor;
      if (Object.prototype.hasOwnProperty.call(p, 'login_alerts')) out.login_alerts = p.login_alerts;
      if (Object.prototype.hasOwnProperty.call(p, 'notify_exams')) out.exam_reminder = p.notify_exams;
      if (Object.prototype.hasOwnProperty.call(p, 'notify_schedule')) out.schedule_updates = p.notify_schedule;
      if (Object.prototype.hasOwnProperty.call(p, 'notify_email')) out.notifications = p.notify_email;
      return out;
    }
            ...
            <div className={`BGC gsap-y pd ${profileLoading && "shimmer"}`}>
              {!profileLoading && <>
                ...
                <div className='flex column center w100'>
                  <Profile width='5em'                   img={profile?.image || `https://api.dicebear.com/7.x/initials/svg?seed=${encodeURIComponent(((profile?.fname || '') + ' ' + (profile?.lname || '')).trim() || 'Teacher')}`} />
